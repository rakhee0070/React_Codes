//Returns the index of last element that satisfies a condition.
//If no match → returns -1.

var arr1=[30,4,10,2,50,6,23,12];
var result1= arr1.findLastIndex((e)=>{
    return e<=10;
})
console.log(result1);
...
const result2=products.findLastIndex((e)=>{
    return e.id==12;
})
console.log(result2);